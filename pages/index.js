            ...
            <ul className=" flex items-center">
              ...
              <li>
                <a
                  ...
                  href="https://drive.google.com/file/d/1zvZwm1eIjIizsmXx61dydYdAWPXB3bYg/view?usp=share_link"
                  target="_blank"
                >
                  Resume
                </a>
            ...
            <div className=" lg:flex gap-10">
              ...
              <div className=" text-center shadow-lg p-10 rounded-xl my-10 basis-1/2  dark:bg-gray-400">
                ...
                <p className=" text-gray-800 w-10/12 mx-auto mt-3 dark:text-black">
                  ...
                  to track time required by workers in warehouse for various on
                  ground activities. This tracking will be used to measure the
                  goodness of any new features that are incorporated. Worked on
                  integrating{" "}
                  <span className="text-teal-500 dark:text-white">vahan</span>{" "}
                  system with existing warehouse console.{" "}
                  <span className="text-teal-500 dark:text-white">
                    Vahan is a robot
                  </span>{" "}
                  which replaces physical movement of goods done by person.
                </p>
              </div>
            </div>
              ...
              <div className="text-center shadow-lg p-2 sm:p-10 rounded-xl my-10 ">
                ...
                <div className="lg:flex">
                  <div className=" text-center dark:border-cyan-500 border-4 sm:border-none sm:shadow-lg p-1 sm:p-10 rounded-xl my-10 mx-5 basis-1/2  dark:bg-gray-400 break-all">
                    ...
                    <p className=" text-gray-800 w-10/12 mx-auto mt-3 dark:text-black">
                      E Commerce Web Application. User can login, logout,
                      add/delete products to cart and order. User can add
                      addresses and select one to which product needs to be
                      delivered. Created privatized routes so that unauthorized
                      access can be prevented. All the Restful API's where
                  ...
                  <div className=" text-center dark:border-cyan-500 border-4 sm:border-none sm:shadow-lg p-1 sm:p-10 rounded-xl my-10 mx-5 basis-1/2  dark:bg-gray-400 break-all">
                    ...
                    <p className=" text-gray-800 w-10/12 mx-auto mt-3 dark:text-black">
                      A complete e-commerce microservice application using
                      NodeJS and RabbitMQ.
                    </p>
                  </div>
                </div>
                ...
                <div className="lg:flex">
                  <div className=" text-center dark:border-cyan-500 border-4 sm:border-none sm:shadow-lg p-1 sm:p-10 rounded-xl my-10 mx-5 basis-1/2  dark:bg-gray-400 break-all">
                    ...
                    <p className=" text-gray-800 w-10/12 mx-auto mt-3 dark:text-black">
                      A microservice based backend to schedule jobs based on
                      their priority Code. Task Scheduling Service that ingests
                      tasks from various microservices and then schedules their
                      execution.
                    </p>
                  </div>
